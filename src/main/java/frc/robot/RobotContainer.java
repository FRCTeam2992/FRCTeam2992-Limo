...
import frc.robot.commands.groups.ClimbMode;
...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    final JoystickButton setClimbModeOn = new JoystickButton(controller1, XboxController.Button.kStart.value);
    setClimbModeOn.whenPressed(new ClimbMode(mClimb, mTurret, mIntake, mShooterHood));
  }
