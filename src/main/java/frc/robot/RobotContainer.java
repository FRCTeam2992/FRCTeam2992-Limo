...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    autoAimButton.whileHeld(new AutoLimelightRange(mShooterHood, mShooter, mTurret, cargoBallInterpolator));
  ...
  public void initInterpolator() {
    ...
    // Backspin, Hood));
    cargoBallInterpolator.addDataPoint(new CargoBallDataPoint(-1000, 1750, 2650, -152));
