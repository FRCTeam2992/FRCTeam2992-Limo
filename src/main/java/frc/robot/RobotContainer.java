...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    moveTurretLeftButton.whileHeld(new MoveTurret(mTurret, 0.25));
    SmartDashboard.putData("Move Turret Left", new MoveTurret(mTurret, 0.25));

    final POVButton moveTurretRightButton = new POVButton(controller0, 90);
    moveTurretRightButton.whileHeld(new MoveTurret(mTurret, -0.25));
    SmartDashboard.putData("Move Turret Right", new MoveTurret(mTurret, -0.25));

    SmartDashboard.putData("Set Turret to 0 degrees", new MoveTurretToAngle(mTurret, 0.0, 10));
    SmartDashboard.putData("Set Turret to 90 degrees", new MoveTurretToAngle(mTurret, 90, 10));
    SmartDashboard.putData("Set Turret to 180 degrees", new MoveTurretToAngle(mTurret, 180, 10));
    SmartDashboard.putData("Set Turret to 270 degrees", new MoveTurretToAngle(mTurret, 270, 10));
  }
